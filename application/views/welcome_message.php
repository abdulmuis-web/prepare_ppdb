...
<body data-spy="scroll" data-target=".mainmenu-area">
    ...
    <header class="home-area overlay" id="home_page">
      ...
      <div class="modal modal-info fade" id="modal-default" style="z-index: 99999999">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                
                <h4 class="modal-title">Pilih Jalur pendaftaran</h4>
              </div>
              <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="#" class="btn btn-primary btn-block"><b>Jalur Prestasi</b></a>
                    </div>
                    <div class="col-sm-4">
                        <a href="#" class="btn btn-warning btn-block"><b>Perpindahan Ortu</b></a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title text-center">
                            ...
                            <h3 class="dark-color">Anda dapat menghubungi kami di kontak berikut</h3>
                            <div class="space-60"></div>
                        </div>
                    </div>
                </div>
